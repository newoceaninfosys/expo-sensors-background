...
//        if (map == null) return result
            ...
            val expoServiceSensor = ExpoSensorService(appContext.reactContext!!)
        ...
        AsyncFunction("hasStartedAsync") { taskName: String, promise: Promise ->
            Log.i("ExpoSensors", "hasStartedAsync")
